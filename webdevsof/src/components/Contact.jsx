...
const Contact = () => {
    ...
    const onSubmit = async (event) => {
        ...
        formData.append("access_key", "b6854509-d1d7-45b6-a9ad-67d8653bfd68");
  ...
  return (
    ...
    className='text-center p-6 py-20 lg:px-32 w-full overflow-hidden' id='contact'>
        ...
        <p className='text-center text-gray-500 mb-12 max-w-80 mx-auto'>Tell us how we can help you.</p>
